                ...
                @if ($tangibles_Keuangan->count() > 0)
                    ...
                    @foreach($tangibles_Keuangan as $key => $item)
                        <tr>
                            ...
                            <td>
                                <input class="form-check-input position-static ml-1" type="radio" name="ku_radio_P_{{ $item->id }}" id="radio_P_{{ $item->id }}_3" value="CB">
                            </td>
                            <td>
                            ...
                            <td>
                                <input class="form-check-input position-static ml-1" type="radio" name="ku_radio_H_{{ $item->id }}" id="radio_H_{{ $item->id }}_3" value="CM">
                            </td>
                            <td>
