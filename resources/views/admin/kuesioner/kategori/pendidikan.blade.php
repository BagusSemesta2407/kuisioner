                ...
                @if ($tangibles_Pendidikan->count() > 0)
                    ...
                    @foreach($tangibles_Pendidikan as $key => $item)
                        <tr>
                            ...
                            <td>
                                <input class="form-check-input position-static ml-1" type="radio" name="pd_radio_P_{{ $item->id }}" id="radio_P_{{ $item->id }}_3" value="CB">
                            </td>
                            <td>
                            ...
                            <td>
                                <input class="form-check-input position-static ml-1" type="radio" name="pd_radio_H_{{ $item->id }}" id="radio_H_{{ $item->id }}_3" value="CM">
                            </td>
                            <td>
