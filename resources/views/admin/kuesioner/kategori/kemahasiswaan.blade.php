                ...
                @if ($tangibles_Kemahasiswaan->count() > 0)
                    ...
                    @foreach($tangibles_Kemahasiswaan as $key => $item)
                        <tr>
                            ...
                            <td>
                                <input class="form-check-input position-static ml-1" type="radio" name="km_radio_P_{{ $item->id }}" id="radio_P_{{ $item->id }}_3" value="CB" checked>
                            </td>
                            <td>
                            ...
                            <td>
                                <input class="form-check-input position-static ml-1" type="radio" name="km_radio_H_{{ $item->id }}" id="radio_H_{{ $item->id }}_3" value="CM" checked>
                            </td>
                            <td>
