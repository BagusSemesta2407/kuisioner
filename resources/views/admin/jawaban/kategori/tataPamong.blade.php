<div class="card my-3">
    <div class="card-body">
        ...
        <table class="table">
            ...
            <tbody>
                @if(!empty($TataPamong['tangibles']))
                    @foreach($TataPamong['tangibles'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($TataPamong['tangibles']) }}" scope="row" class="text-center">Tangibles</th> 
                            @endif
                ...
                @if(!empty($TataPamong['reliability']))
                    @foreach($TataPamong['reliability'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($TataPamong['reliability']) }}" scope="row" class="text-center">Reliability</th>
                            @endif
                            <td class="line3">{!! $kuesionerItem['kuesioner']->pertanyaan !!}</td>
                            <td>
                                <input class="form-check-input position-static ml-1" type="radio" name="radio_P_{{ $kuesionerItem['kuesioner']->id }}" id="radio_P_{{ $kuesionerItem['kuesioner']->id }}_1" value="STB" {{ $kuesionerItem['jawaban'][0] == 'STB' ? 'checked' : '' }} disabled>
                ...
                @if(!empty($TataPamong['responsiveness']))
                    @foreach($TataPamong['responsiveness'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($TataPamong['responsiveness']) }}" scope="row" class="text-center">Responsiveness</th>
                            @endif
                            <td class="line3">{!! $kuesionerItem['kuesioner']->pertanyaan !!}</td>
                            <td>
                ...
                @if(!empty($TataPamong['assurance']))
                    @foreach($TataPamong['assurance'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($TataPamong['assurance']) }}" scope="row" class="text-center">Assurance</th>
                            @endif
                            <td class="line3">{!! $kuesionerItem['kuesioner']->pertanyaan !!}</td>
                            <td>
                                <input class="form-check-input position-static ml-1" type="radio" name="radio_P_{{ $kuesionerItem['kuesioner']->id }}" id="radio_P_{{ $kuesionerItem['kuesioner']->id }}_1" value="SK" {{ $kuesionerItem['jawaban'][0] == 'SK' ? 'checked' : '' }} disabled>
                ...
                @if(!empty($TataPamong['empathy']))
                    @foreach($TataPamong['empathy'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($TataPamong['empathy']) }}" scope="row" class="text-center">Empathy</th>
                            @endif
                            <td class="line3">{!! $kuesionerItem['kuesioner']->pertanyaan !!}</td>
                            <td>
                                <input class="form-check-input position-static ml-1" type="radio" name="radio_P_{{ $kuesionerItem['kuesioner']->id }}" id="radio_P_{{ $kuesionerItem['kuesioner']->id }}_1" value="SK" {{ $kuesionerItem['jawaban'][0] == 'SK' ? 'checked' : '' }} disabled>
