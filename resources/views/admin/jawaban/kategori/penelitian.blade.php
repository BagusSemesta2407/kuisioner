<div class="card my-3">
    <div class="card-body">
        ...
        <table class="table">
            ...
            <tbody>
                @if(!empty($Penelitian['tangibles']))
                    @foreach($Penelitian['tangibles'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($Penelitian['tangibles']) }}" scope="row" class="text-center">Tangibles</th> 
                            @endif
                ...
                @if(!empty($Penelitian['reliability']))
                    @foreach($Penelitian['reliability'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($Penelitian['reliability']) }}" scope="row" class="text-center">Reliability</th>
                            @endif
                            <td class="line3">{!! $kuesionerItem['kuesioner']->pertanyaan !!}</td>
                            <td>
                                <input class="form-check-input position-static ml-1" type="radio" name="radio_P_{{ $kuesionerItem['kuesioner']->id }}" id="radio_P_{{ $kuesionerItem['kuesioner']->id }}_1" value="STB" {{ $kuesionerItem['jawaban'][0] == 'STB' ? 'checked' : '' }} disabled>
                ...
                @if(!empty($Penelitian['responsiveness']))
                    @foreach($Penelitian['responsiveness'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($Penelitian['responsiveness']) }}" scope="row" class="text-center">Responsiveness</th>
                            @endif
                            <td class="line3">{!! $kuesionerItem['kuesioner']->pertanyaan !!}</td>
                            <td>
                ...
                @if(!empty($Penelitian['assurance']))
                    @foreach($Penelitian['assurance'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($Penelitian['assurance']) }}" scope="row" class="text-center">Assurance</th>
                            @endif
                            <td class="line3">{!! $kuesionerItem['kuesioner']->pertanyaan !!}</td>
                            <td>
                                <input class="form-check-input position-static ml-1" type="radio" name="radio_P_{{ $kuesionerItem['kuesioner']->id }}" id="radio_P_{{ $kuesionerItem['kuesioner']->id }}_1" value="SK" {{ $kuesionerItem['jawaban'][0] == 'SK' ? 'checked' : '' }} disabled>
                ...
                @if(!empty($Penelitian['empathy']))
                    @foreach($Penelitian['empathy'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($Penelitian['empathy']) }}" scope="row" class="text-center">Empathy</th>
                            @endif
                            <td class="line3">{!! $kuesionerItem['kuesioner']->pertanyaan !!}</td>
                            <td>
                                <input class="form-check-input position-static ml-1" type="radio" name="radio_P_{{ $kuesionerItem['kuesioner']->id }}" id="radio_P_{{ $kuesionerItem['kuesioner']->id }}_1" value="SK" {{ $kuesionerItem['jawaban'][0] == 'SK' ? 'checked' : '' }} disabled>
