<div class="card my-3">
    <div class="card-body">
        ...
        <table class="table">
            ...
            <tbody>
                @if(!empty($Keuangan['tangibles']))
                    @foreach($Keuangan['tangibles'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($Keuangan['tangibles']) }}" scope="row" class="text-center">Tangibles</th> 
                            @endif
                ...
                @if(!empty($Keuangan['reliability']))
                    @foreach($Keuangan['reliability'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($Keuangan['reliability']) }}" scope="row" class="text-center">Reliability</th>
                            @endif
                            <td class="line3">{!! $kuesionerItem['kuesioner']->pertanyaan !!}</td>
                            <td>
                                <input class="form-check-input position-static ml-1" type="radio" name="radio_P_{{ $kuesionerItem['kuesioner']->id }}" id="radio_P_{{ $kuesionerItem['kuesioner']->id }}_1" value="STB" {{ $kuesionerItem['jawaban'][0] == 'STB' ? 'checked' : '' }} disabled>
                ...
                @if(!empty($Keuangan['responsiveness']))
                    @foreach($Keuangan['responsiveness'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($Keuangan['responsiveness']) }}" scope="row" class="text-center">Responsiveness</th>
                            @endif
                            <td class="line3">{!! $kuesionerItem['kuesioner']->pertanyaan !!}</td>
                            <td>
                ...
                @if(!empty($Keuangan['assurance']))
                    @foreach($Keuangan['assurance'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($Keuangan['assurance']) }}" scope="row" class="text-center">Assurance</th>
                            @endif
                            <td class="line3">{!! $kuesionerItem['kuesioner']->pertanyaan !!}</td>
                            <td>
                                <input class="form-check-input position-static ml-1" type="radio" name="radio_P_{{ $kuesionerItem['kuesioner']->id }}" id="radio_P_{{ $kuesionerItem['kuesioner']->id }}_1" value="SK" {{ $kuesionerItem['jawaban'][0] == 'SK' ? 'checked' : '' }} disabled>
                ...
                @if(!empty($Keuangan['empathy']))
                    @foreach($Keuangan['empathy'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($Keuangan['empathy']) }}" scope="row" class="text-center">Empathy</th>
                            @endif
                            <td class="line3">{!! $kuesionerItem['kuesioner']->pertanyaan !!}</td>
                            <td>
                                <input class="form-check-input position-static ml-1" type="radio" name="radio_P_{{ $kuesionerItem['kuesioner']->id }}" id="radio_P_{{ $kuesionerItem['kuesioner']->id }}_1" value="SK" {{ $kuesionerItem['jawaban'][0] == 'SK' ? 'checked' : '' }} disabled>
