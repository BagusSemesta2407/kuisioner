<div class="card my-3">
    <div class="card-body">
        ...
        <table class="table">
            ...
            <tbody>
                @if(!empty($SaranaPrasana['tangibles']))
                    @foreach($SaranaPrasana['tangibles'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($SaranaPrasana['tangibles']) }}" scope="row" class="text-center">Tangibles</th> 
                            @endif
                ...
                @if(!empty($SaranaPrasana['reliability']))
                    @foreach($SaranaPrasana['reliability'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($SaranaPrasana['reliability']) }}" scope="row" class="text-center">Reliability</th>
                            @endif
                            <td class="line3">{!! $kuesionerItem['kuesioner']->pertanyaan !!}</td>
                            <td>
                                <input class="form-check-input position-static ml-1" type="radio" name="radio_P_{{ $kuesionerItem['kuesioner']->id }}" id="radio_P_{{ $kuesionerItem['kuesioner']->id }}_1" value="STB" {{ $kuesionerItem['jawaban'][0] == 'STB' ? 'checked' : '' }} disabled>
                ...
                @if(!empty($SaranaPrasana['responsiveness']))
                    @foreach($SaranaPrasana['responsiveness'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($SaranaPrasana['responsiveness']) }}" scope="row" class="text-center">Responsiveness</th>
                            @endif
                            <td class="line3">{!! $kuesionerItem['kuesioner']->pertanyaan !!}</td>
                            <td>
                ...
                @if(!empty($SaranaPrasana['assurance']))
                    @foreach($SaranaPrasana['assurance'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($SaranaPrasana['assurance']) }}" scope="row" class="text-center">Assurance</th>
                            @endif
                            <td class="line3">{!! $kuesionerItem['kuesioner']->pertanyaan !!}</td>
                            <td>
                                <input class="form-check-input position-static ml-1" type="radio" name="radio_P_{{ $kuesionerItem['kuesioner']->id }}" id="radio_P_{{ $kuesionerItem['kuesioner']->id }}_1" value="SK" {{ $kuesionerItem['jawaban'][0] == 'SK' ? 'checked' : '' }} disabled>
                ...
                @if(!empty($SaranaPrasana['empathy']))
                    @foreach($SaranaPrasana['empathy'] as $key => $kuesionerItem)
                        <tr>
                            @if($key === 0)
                                <th rowspan="{{ count($SaranaPrasana['empathy']) }}" scope="row" class="text-center">Empathy</th>
                            @endif
                            <td class="line3">{!! $kuesionerItem['kuesioner']->pertanyaan !!}</td>
                            <td>
                                <input class="form-check-input position-static ml-1" type="radio" name="radio_P_{{ $kuesionerItem['kuesioner']->id }}" id="radio_P_{{ $kuesionerItem['kuesioner']->id }}_1" value="SK" {{ $kuesionerItem['jawaban'][0] == 'SK' ? 'checked' : '' }} disabled>
