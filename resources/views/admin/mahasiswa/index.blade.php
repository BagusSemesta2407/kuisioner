                ...
                @if (Auth::user()->role = 'p4mp')
                    ...
                    {{-- <div class="col-2">
                        <select class="form-select" name="periode" id="tingkat_filter" required>
                            ...
                            <option
                                value="{{ route('user.mahasiswa', ['jurusan' => $jurusan, 'tingkat' => 'semua', 'periode' => $periode]) }}"
                                {{ $tingkat == 'semua' ? 'selected' : '' }}>Semester</option>
                            @for ($i = 1; $i <= 8; $i++)
                                <option
                                    value="{{ route('user.mahasiswa', ['jurusan' => $jurusan, 'tingkat' => $i, 'periode' => $periode]) }}"
                                    {{ $tingkat == $i ? 'selected' : '' }}>Semester {{ $i }}</option>
                            @endfor
                        </select>
                    </div> --}}
                    ...
                    {{-- <div class="col-2">
                        <select class="form-select" name="periode" id="periode_filter" required>
                            ...
                            <option
                                value="{{ route('user.mahasiswa', ['jurusan' => $jurusan, 'tingkat' => $tingkat, 'periode' => 'semua']) }}"
                                {{ $periode == 'semua' ? 'selected' : '' }}>Periode</option>
                            @for ($i = 2015; $i <= 2025; $i++)
                                <option
                                    value="{{ route('user.mahasiswa', ['jurusan' => $jurusan, 'tingkat' => $tingkat, 'periode' => $i]) }}"
                                    {{ $periode == $i ? 'selected' : '' }}>{{ $i - 1 }}/{{ $i }}
                                </option>
                            @endfor
                        </select>
                    </div> --}}
                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td>
                                <button type="button" class="px-4 py-2 btn btn-warning" data-bs-toggle="modal"
                                ...
                                <div class="modal fade" id="EditModal{{ $user->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="{{ route('mahasiswa.update', $user->id) }}">
                                                @method('PUT')
                                                @csrf
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="name" class="form-control"
                                                                id="name" placeholder="Masukan Nama Mahasiswa"
                                                    ...
                                                    <div class="row">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="username" class="form-control"
                                                                id="username" placeholder="Masukan NIM Mahasiswa"
                                                    ...
                                                    <div class="row">
                                                        <div class="mb-3 col-6">
                                                            <label for="tahun_masuk" class="form-label">Tahun Masuk</label>
                                                            <select class="form-select" name="tahun_masuk" id="tahun_masuk"
                                                                required>
                                                                @for ($i = 2015; $i <= 2025; $i++)
                                                                    <option
                                                                        value="{{ $i - 1 }}"
                                                                        {{ $user->tahun_masuk == $i - 1 ? 'selected' : '' }}>
                                                                        {{ $i - 1 }}</option>
                                                                @endfor
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="mb-3 col-12">
                                                            ...
                                                            <select class="form-select" name="jurusan_id" id="jurusan_id" required>
                                                                ...
                                                                @foreach ($jurusan as $jr)
                                                                    <option value="{{ $jr->id }}"
                                                                        {{ old('jurusan_id', $user->jurusan_id) == $jr->id ? 'selected' : '' }}>
                                                                        {{ $jr->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="mb-3 col-12">
                                                            ...
                                                            <select class="form-select" name="program_studi_id" id="program_studi_id" required>
                                                                ...
                                                                @foreach ($programStudi as $ps)
                                                                    <option value="{{ $ps->id }}"
                                                                        {{ old('program_studi_id', $user->program_studi_id) == $ps->id ? 'selected' : '' }}>
                                                                        {{ $ps->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="mb-3 col-12">
                                                            ...
                                                            <select class="form-select" name="status" id="status"
                                                                ...
                                                                <option value="Tidak Aktif"
                                                                    ...
                                                                    Tidak Aktif</option>
                                                                <option value="Lulus"
                                                                    {{ $user->status == 'Lulus' ? 'selected' : '' }}>Lulus
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="px-4 py-2 btn btn-secondary"
                                                        data-bs-dismiss="modal">Close</button>
                                                    <button type="submit" class="px-4 py-2 btn btn-warning">Edit
                                                        Data</button>
                                                </div>
                                            </form>
                                        </div>
                                ...
                                <button type="button" class="px-4 py-2 btn btn-danger" data-bs-toggle="modal"
                                ...
                                <div class="modal fade" id="DeleteModal{{ $user->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="{{ route('admin-jurusan.destroy', $user->id) }}">
                                                @method('DELETE')
                                                @csrf
                                                <div class="modal-body">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="px-4 py-2 btn btn-secondary"
                                                        data-bs-dismiss="modal">Close</button>
                                                    <button type="submit" class="px-4 py-2 btn btn-danger">Hapus
                                                        Data</button>
                                                </div>
                                            </form>
                                        </div>
                                ...
                                <button type="button" class="px-4 py-2 btn btn-info" data-bs-toggle="modal"
                                    data-bs-target="#Password{{ $user->id }}">
                                    Password
                                </button>
                                <!-- Modal -->
                                <div class="modal fade" id="Password{{ $user->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="{{ route('pw-reset', $user->id) }}">
                                                @method('PUT')
                                                @csrf
                                                <div class="modal-body">
                                                    <div class="row">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="px-4 py-2 btn btn-secondary"
                                                        data-bs-dismiss="modal">Close</button>
                                                    <button type="submit" class="px-4 py-2 btn btn-info">Ubah
                                                        Password</button>
                                                </div>
                                            </form>
                                        </div>
