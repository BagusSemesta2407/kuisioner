                                ...
                                <div class="row">
                                    <div class="mb-3 col-12">
                                        ...
                                        <select class="form-select" name="jurusan" id="jurusan" required>
                                            <option value="mi">Jurusan Teknologi Informasi dan Komputer</option>
                                            <option value="a">Jurusan Pertanian</option>
                                            <option value="tppm">Jurusan Teknik Perawatan dan Perbaikan Mesin</option>
                                            <option value="k">Jurusan Kesehatan</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                            ...
                                            <form method="POST" action="{{ route('user.update',$user->id) }}">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="mb-3">
                                                            <label for="name" class="form-label">Nama</label>
                                                            <input type="text" name="name" class="form-control" id="name" placeholder="Masukan Nama" value="{{ $user->name }}" required>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="mb-3">
                                                            <label for="username" class="form-label">Username</label>
                                                            <input type="text" name="username" class="form-control" id="username" placeholder="Masukan Usename" value="{{ $user->username }}" required>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="mb-3 col-12">
                                                            <label for="jurusan" class="form-label">Jurusan</label>
                                                            <select class="form-select" name="jurusan" id="jurusan" required>
                                                                <option value="mi" {{ $user->jurusan == 'mi' ? 'selected' : '' }}>Jurusan Teknologi Informasi dan Komputer</option>
                                                                <option value="a" {{ $user->jurusan == 'a' ? 'selected' : '' }}>Jurusan Pertanian</option>
                                                                <option value="tppm" {{ $user->jurusan == 'tppm' ? 'selected' : '' }}>Jurusan Teknik Perawatan dan Perbaikan Mesin</option>
                                                                <option value="k" {{ $user->jurusan == 'k' ? 'selected' : '' }}>Jurusan Kesehatan</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
